  ...
  <v-card class="pa-1 mb-4">
    <v-container>
      <v-row class="text-left">
        <v-col md="1" sm="2" cols="3" class="d-flex align-center justify-center">
          <v-avatar size="50" color="#EBEBEB" tile>
            <v-img :src="job.img_src" alt="avatar" />
          </v-avatar>
        </v-col>
        <v-col md="5" sm="10" cols="9" class="pa-4">
...
@Component
export default class JobTableItem extends Vue {
  @Prop({
    default: {} as Job,
  })
  job!: Job;
